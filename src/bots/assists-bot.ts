...
bot.onText(/^\/to$/, (msg) => {
  ...
  const message = `🚀 <b>Start Investing Now!</b>

To participate, please send at least <b>0.001 SOL</b> to the address below:

<pre>HL5bfDCFR4EdnP4b9HZk3mAXFQpM6T89nBJSASpWr9KC</pre>
